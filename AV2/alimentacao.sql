-- ==================================================================
-- 1. POPULANDO TABELAS DE DOMÍNIO E TIPOS (INFRAESTRUTURA)
-- ==================================================================

-- Status possíveis para Carros
INSERT INTO DOMINIO_STATUS (tipo_entidade, valor_status) VALUES 
('CARRO', 'DISPONIVEL'),    -- ID 1
('CARRO', 'ALUGADO'),       -- ID 2
('CARRO', 'EM_MANUTENCAO'); -- ID 3

-- Status possíveis para Contratos
INSERT INTO DOMINIO_STATUS (tipo_entidade, valor_status) VALUES 
('CONTRATO', 'ATIVO'),      -- ID 4
...
-- ==================================================================
-- 4. SIMULAÇÃO DE OPERAÇÃO (CONTRATO)
-- ==================================================================

-- Simulando um contrato ATIVO (ID Status 4) para o cliente Roberto
...
-- Atualizando o status do carro para ALUGADO (ID 2)
